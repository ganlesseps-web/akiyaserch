...
## Now
MVP一通り完成 (2026-05-26)。`みんなの0円物件` から RSS+詳細ページで10件取得 → SQLite 保存 → フィルタ → Discord通知 → Webダッシュボード までend-to-end稼働確認済み。GitHub に push 済み (https://github.com/ganlesseps-web/akiyaserch, main)。Discord Webhook URL設定 + launchd登録 で運用開始できる状態。
