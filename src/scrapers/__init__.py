...
from .akiya_athome import (
    ...
    KasaiAkiyabankScraper,
    NishiwakiAkiyabankScraper,
    MimaAkiyabankScraper,
    KinokawaAkiyabankScraper,
    TsuAkiyabankScraper,
    NakaAkiyabankScraper,
    KatsuragiAkiyabankScraper,
    HigashiomiAkiyabankScraper,
    HinoAkiyabankScraper,
    OyodoAkiyabankScraper,
    SakuraiAkiyabankScraper,
    MitsueAkiyabankScraper,
    YamazoeAkiyabankScraper,
)
...
REGISTRY: dict[str, type[Scraper]] = {
    ...
    "kasai_akiyabank": KasaiAkiyabankScraper,
    "nishiwaki_akiyabank": NishiwakiAkiyabankScraper,
    "mima_akiyabank": MimaAkiyabankScraper,
    "kinokawa_akiyabank": KinokawaAkiyabankScraper,
    "tsu_akiyabank": TsuAkiyabankScraper,
    "naka_akiyabank": NakaAkiyabankScraper,
    "katsuragi_akiyabank": KatsuragiAkiyabankScraper,
    "higashiomi_akiyabank": HigashiomiAkiyabankScraper,
    "hino_akiyabank": HinoAkiyabankScraper,
    "oyodo_akiyabank": OyodoAkiyabankScraper,
    "sakurai_akiyabank": SakuraiAkiyabankScraper,
    "mitsue_akiyabank": MitsueAkiyabankScraper,
    "yamazoe_akiyabank": YamazoeAkiyabankScraper,
}
